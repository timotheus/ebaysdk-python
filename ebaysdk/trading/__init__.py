...
class Connection(BaseConnection):
    ...
    def __init__(self, **kwargs):
        ...
        self.base_list_nodes = [
            ...
            'getitemresponse.item.picturedetails.pictureurl',
            'getitemresponse.item.variations.variation',
            'getitemresponse.item.variations.variation.variationspecifics.namevaluelist',
            'getitemresponse.item.variations.pictures.variationspecificpictureset',
            'getitemresponse.item.variations.pictures.variationspecificpictureset.pictureurl',
            'getitemresponse.item.itemspecifics.namevaluelist',
